    ...
    public class DiagnosticsNodeManager : CustomNodeManager2
    {
        ...
        protected override NodeState AddBehaviourToPredefinedNode(ISystemContext context, NodeState predefinedNode)
        {
            ...
            if (passiveNode == null)
            {
                ...
                if (passiveMethod.NodeId == MethodIds.ServerType_LookupAliasesForNodeIds)
                {
                    LookupAliasesForNodeIdsMethodState activeNode = new LookupAliasesForNodeIdsMethodState(passiveMethod.Parent);
                    activeNode.Create(context, passiveMethod);
                    ...
                    activeNode.OnCall = OnLookupAliasesForNodeIds;

                    return activeNode;
                }

                if (passiveMethod.NodeId == MethodIds.ServerType_LookupNodeIdsForAliases)
                {
                    LookupNodeIdsForAliasesMethodState activeNode = new LookupNodeIdsForAliasesMethodState(passiveMethod.Parent);
                    activeNode.Create(context, passiveMethod);
                    ...
                    activeNode.OnCall = OnLookupNodeIdsForAliases;
        ...
        /// <summary>
        /// Handles a request to lookup aliases for node ids.
        /// </summary>
        private ServiceResult OnLookupAliasesForNodeIds(
            ISystemContext context,
            MethodState method,
            NodeId[] nodeIds,
            ref string[] aliases)
        {
            ...
            aliases = new string[nodeIds.Length];
            Server.LookupAliasesForNodeIds(systemContext, nodeIds, aliases);

            return ServiceResult.Good;
        }

        /// <summary>
        /// Handles a request to lookup node ids for aliases.
        /// </summary>
        private ServiceResult OnLookupNodeIdsForAliases(
            ISystemContext context,
            MethodState method,
            string[] aliases,
            ref NodeId[] nodeIds)
        {
            ...
            nodeIds = new NodeId[aliases.Length];
            Server.LookupNodeIdsForAliases(systemContext, aliases, nodeIds);
        ...
        public void AddAggregateFunction(NodeId aggregateId, string aggregateName, bool isHistorical)
        {
            lock (Lock)
            {
                AggregateFunctionsState state = new AggregateFunctionsState(null);
