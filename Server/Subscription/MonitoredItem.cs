...
{	
	...
	/// </summary>
    public class MonitoredItem : IEventMonitoredItem, ISampledDataChangeMonitoredItem
	{
		#region Constructors
		/// <summary>
        ...
        public bool IsReadyToPublish
        {
            get
            {
                ...
                // Utils.Trace("IsReadyToPublish[{0}] TRUE", m_id);
                return true;
            }
        }
        ...
        {            
            ...
            // Utils.Trace("QUEUE VALUE: Value={0} CODE={1}<{1:X8}> OVERFLOW={2}", m_lastValue.WrappedValue, m_lastValue.StatusCode.Code, m_lastValue.StatusCode.Overflow);
        }
