//<summary>
//  Title   : TraceEvent in CAS.UA.Server.DataBindings
...
{
  /// <summary>
  /// class responsible for tracing inside BaseStation - please use TraceSource( "CAS.UA.Server.DataBindings.TraceEvent" )
  /// </summary>
