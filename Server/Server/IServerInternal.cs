...
namespace Opc.Ua.Server
{
    ...
    public interface IServerInternal
    {
        ...
        void LookupAliasesForNodeIds(ServerSystemContext context, NodeId[] nodeIds, string[] aliases);
        ...
        /// <param name="aliases">The aliases.</param>
        /// <param name="nodeIds">The node ids.</param>
        void LookupNodeIdsForAliases(ServerSystemContext context, string[] aliases, NodeId[] nodeIds);
    }
}
