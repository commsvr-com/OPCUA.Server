    ...
    public class ServerInternalData : IServerInternal, IDisposable
    {
        ...
        public bool IsRunning
        {
            ...
            { 
                ...
                lock (m_serverStatus.Lock)
                {
                    return m_serverStatus.Value.State == ServerState.Running; 
                }
            }
        }
        ...
        public void LookupAliasesForNodeIds(ServerSystemContext context, NodeId[] nodeIds, string[] aliases)
        {
            m_nodeManager.LookupAliasesForNodeIds(context, nodeIds, aliases);
        }
        ...
        /// <param name="aliases">The aliases.</param>
        /// <param name="nodeIds">The node ids.</param>
        public void LookupNodeIdsForAliases(ServerSystemContext context, string[] aliases, NodeId[] nodeIds)
        {
            m_nodeManager.LookupNodeIdsForAliases(context, aliases, nodeIds);
        }
        #endregion
